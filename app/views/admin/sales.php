                    ...
                    <tbody class="divide-y divide-gray-700" id="ordersBody">
                        ...
                        <tr class="hover:bg-white/5 transition duration-150 order-row" 
                            ...
                            <td class="p-4 align-middle" data-val="<?= strtolower($o['user_account_name'] ?? '') ?>">
                                ...
                                <?php 
                                    ...
                                    if (!empty($o['customer_phone'])) {
                                        $phoneDisplay = htmlspecialchars($o['customer_phone']);
                                    } elseif (!empty($o['phone'])) {
                                        $phoneDisplay = htmlspecialchars($o['phone']);
                                    }
                                ?>
                            ...
                            <td class="p-4 align-middle" data-val="<?= $o['total_amount'] ?>">
                                <div class="text-white font-bold font-mono"><?= number_format($o['total_amount']) ?></div>
                            ...
                            <td class="p-4 align-middle text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <?php if(isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin' && !in_array($o['status'], ['cancelled', 'rejected'])): ?>
